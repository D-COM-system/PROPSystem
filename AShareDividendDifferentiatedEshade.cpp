...
void createAShareDividendDifferentiatedEshade(QString dirPath)
{
...
//    QXlsx::Worksheet* sheet = excelFile.currentWorksheet();
    ...
    QSqlQuery query;
    QString createQuery = "CREATE TABLE AShareDividendDifferentiatedEshade ("
                          "AShareDividendDifferentiatedEshadeID VARCHAR(64),"
                          "TransactionSerialNumber VARCHAR(40),"
                          "CLJG VARCHAR(10),"
                          "SBBH VARCHAR(40),"
                          "FZDM VARCHAR(10),"
                          "JGDM VARCHAR(10),"
